...
It extracts the script's functionality such that it can be imported
and used within other scripts.
Please see the URL above for the original script.
"""
...
MODEL_DIR = os.path.join(tempfile.gettempdir(), 'imagenet')
